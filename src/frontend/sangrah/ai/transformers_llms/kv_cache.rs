...
use crate::frontend::sangrah::common::tensor::TensorSnapshot;
...
mod tests {
    ...
    pub(crate) fn cache_tensor(id: &str, values: Vec<f32>) -> TensorSnapshot {
        TensorSnapshot::try_new(
            ...
            values,
            vec![
                crate::frontend::sangrah::common::tensor::TensorAxis::with_elements(
                    "token",
                    "Tokens",
                    [
                        ("token.the", "The"),
                ...
                crate::frontend::sangrah::common::tensor::TensorAxis::new(
                    "feature",
                    "Head features",
                    vec!["f0", "f1", "f2"],
                ),
