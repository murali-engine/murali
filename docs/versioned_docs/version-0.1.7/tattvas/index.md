...
- [Composite](composite) — cards, axes, number plane, and 3D axes
...
- [AI Diagrams](ai) — semantic tensors and operations, trace ingestion, attention and transformer views, neural diagrams, signal flows, and AI indicators
