...
This catalog is the engine repository's Rust examples.

If you are new to Murali, start with [Your First Scene](../first-scene.md) and [Animations](../animations.md).
...
The full catalog lives in the repository at [`examples/README.md`](https://github.com/murali-engine/murali/blob/main/examples/README.md).
