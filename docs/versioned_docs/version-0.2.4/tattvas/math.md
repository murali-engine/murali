...
Math tattvas live under `murali::frontend::collection::maths::notation`. These are higher-level constructs for mathematical notation.
...
`murali::frontend::collection::maths::linear_algebra`, but it is currently experimental and gated
...
```rust
use murali::frontend::collection::maths::notation::equation::{EquationLayout, EquationPart};
use murali::colors::*;
...
```rust
use murali::frontend::collection::maths::notation::matrix::Matrix;
...
```rust
use murali::frontend::collection::maths::notation::equation::VectorTypstEquation;
