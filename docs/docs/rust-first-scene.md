...
Python authors should start with [Your First Scene](./first-scene.md). This page is the Rust
engine walkthrough for people working on the runtime itself.
...
Python authors should switch to [Your First Scene](./first-scene) and the [Mental Model](./mental-model).

For Rust engine work:

1. **[Architecture Overview](./architecture/overview)** - How the runtime is layered
2. **[Animations](./animations)** - Complete reference for animation verbs
3. **[Tattvas](./tattvas/)** - Native visual objects
4. **[Scene and App](./scene-and-app)** - Scene management and `App`
